 ...
 * @wordpress-plugin
 * Plugin Name:       Været
 * Plugin URI:        https://www.vaeret1.com/widgets
 * Description:       Beautiful Norwegian weather forecasting widget.
 * Version:           1.0.0
 * Author:            avivvaeret
 * Author URI:        https://profiles.wordpress.org/avivvaeret/
 * License:           GPL-2.0+
 ...
 */
define( 'VAERET_VERSION', '1.0.0' );

/**
 * The code that runs during plugin activation.
 * This action is documented in includes/class-vaeret-activator.php
 */
function activate_vaeret() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-vaeret-activator.php';
	Vaeret_Activator::activate();
}

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-vaeret-deactivator.php
 */
function deactivate_vaeret() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-vaeret-deactivator.php';
	Vaeret_Deactivator::deactivate();
}

register_activation_hook( __FILE__, 'activate_vaeret' );
register_deactivation_hook( __FILE__, 'deactivate_vaeret' );

/**
 * The core plugin class that is used to define internationalization,
 * admin-specific hooks, and public-facing site hooks.
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-vaeret.php';
...
class vaeret_widget extends WP_Widget
{
    // Set up the widget name and description.
    public function __construct()
    {
        $widget_options = array('classname' => 'vaeret_widget', 'description' => 'Norwegian weather forecast widget. All locations around the world');
        parent::__construct('vaeret_widget', 'Været Widget', $widget_options);
    }
    ...
    public function widget($args, $instance)
    {
        ...
        echo '<div class="vaeret-widget weather_widget_wrap"
    ...
    {
        // print_r($instance);
        $city = !empty($instance['city']) ? $instance['city'] : 'Oslo';
        $country = !empty($instance['country']) ? $instance['country'] : 'Norway';
            ...
            <div class="form-section">
                ...
                <div class="form-line">
                    <select name="<?php echo $this->get_field_name('language'); ?>">
                        ...
                        <option value="norwegian" <?php if ($language == "norwegian") {
                            echo 'selected';
                        } ?>>Norwegian
                        </option>
                    </select>
...
// Register the widget.
function jpen_register_vaeret_widget()
{
    register_widget('vaeret_widget');
}

add_action('widgets_init', 'jpen_register_vaeret_widget');
